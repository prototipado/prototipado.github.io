...
{% include figure popup=true image_path="/assets/images/sensor_dolor/sensor.png" alt="Sensor de presión" caption="Sensor de presión, vista interior." class="align-center" %}
...
{% include figure popup=true image_path="/assets/images/sensor_dolor/estiumulador.png" alt="Algómetro robótico" caption="Estimulador manual, vista en corte." class="align-center" %}
...
{% include figure popup=true image_path="/assets/images/sensor_dolor/gabinete.png" alt="Gabinete" caption="Gabinete del sistema de control, vista interna." class="align-center" %}
...
{% include figure popup=true image_path="/assets/images/sensor_dolor/luer.jpeg" alt="Traba Luer" caption="Traba Luer reutilizada para la colocación de la aguja." class="align-center" %}
...
{% include figure popup=true image_path="/assets/images/sensor_dolor/setup_pruebas.jpg" alt="Setup de pruebas" caption="Setup de pruebas, con el sensor sobre una pesa de 100 gramos." class="align-center" %}
...
{% include figure popup=true image_path="/assets/images/sensor_dolor/analisis_0gr_10Hz.png" alt="Análisis en vacío a 10Hz" caption="Resultados del análisis de señal en vacío (0g) a una frecuencia de 10Hz." class="align-center" %}

{% include figure popup=true image_path="/assets/images/sensor_dolor/analisis_0gr_500Hz.png" alt="Análisis en vacío a 500Hz" caption="Resultados del análisis de señal en vacío (0g) a una frecuencia de 500Hz." class="align-center" %}

{% include figure popup=true image_path="/assets/images/sensor_dolor/analisis_100gr_10Hz.png" alt="Análisis con carga de 100g a 10Hz" caption="Resultados del análisis de señal con una carga de 100g a una frecuencia de 10Hz." class="align-center" %}

{% include figure popup=true image_path="/assets/images/sensor_dolor/analisis_100gr_500Hz.png" alt="Análisis con carga de 100g a 500Hz" caption="Resultados del análisis de señal con una carga de 100g a una frecuencia de 500Hz." class="align-center" %}
